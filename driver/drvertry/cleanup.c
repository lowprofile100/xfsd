...
#define BugCheckFileId                   (XFS_BUG_CHECK_CLEANUP)
...

{
    ...
    //  reads will be rejected (XVerifyFcbOperation)
    //

    XAcquireFileExclusive( IrpContext, Fcb);
    ...
    try {
        ...
        XDecrementCleanupCounts( IrpContext, Fcb );
